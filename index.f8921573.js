...
function $60311f4dbdf661c8$var$getCleanPathName(path) {
    ...
    if (fullPath.startsWith(this.basePath)) {
        const replacedPath = fullPath.replace(this.basePath, "");
        if (replacedPath == "") return "/";
        else return replacedPath;
    } else return fullPath;
}
function $60311f4dbdf661c8$var$getRealPathName(path) {
    if (this.basePath == "") return path;
    else return $60311f4dbdf661c8$var$basePath + path;
}
...
function $60311f4dbdf661c8$export$cf7ee87ede64229c(container) {
    function goTo(path) {
        ...
        history.pushState({}, "", $60311f4dbdf661c8$var$getRealPathName(path));
...
//# sourceMappingURL=index.f8921573.js.map
