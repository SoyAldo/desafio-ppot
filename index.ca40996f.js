function e(e){return e&&e.__esModule?e.default:e}var t,n=globalThis,a={},s={},i=n.parcelRequire94c2;null==i&&((i=function(e){if(e in a)return a[e].exports;if(e in s){var t=s[e];delete s[e];var n={id:e,exports:{}};return a[e]=n,t.call(n.exports,n,n.exports),n.exports}var i=Error("Cannot find module '"+e+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(e,t){s[e]=t},n.parcelRequire94c2=i),(0,i.register)("27Lyk",function(e,t){Object.defineProperty(e.exports,"register",{get:()=>n,set:e=>n=e,enumerable:!0,configurable:!0});var n,a=new Map;n=function(e,t){for(var n=0;n<t.length-1;n+=2)a.set(t[n],{baseUrl:e,path:t[n+1]})}}),i("27Lyk").register(new URL("",import.meta.url).toString(),JSON.parse('["hvItV","index.ca40996f.js","3mNOk","paper.d83397f1.svg","2HYBq","rock.6c4f4789.svg","bQb7J","shears.3817db3b.svg","5h9CN","index.99d657f3.css"]'));class o extends HTMLElement{constructor(){super()}render(){let e=this.attachShadow({mode:"open"}),t=document.createElement("style");t.textContent=`
    ...
    `;let n=document.createElement("button");if(n.setAttribute("type","button"),n.setAttribute("title","button"),n.classList.add("start-button"),this.childNodes.length>0){let e=this.childNodes[0];n.textContent=e.textContent,e.remove()}n.onclick=()=>{let e=new CustomEvent("bluebuttonpressed",{bubbles:!0,composed:!0});this.dispatchEvent(e)},e.appendChild(t),e.appendChild(n)}connectedCallback(){this.render()}}class r extends HTMLElement{constructor(){super(),this.counter=3}render(){let e=this.attachShadow({mode:"open"}),t=document.createElement("style");t.textContent=`
    * {
      margin: 0;
      padding: 0;
    }
    ...
    * {
    ...
    `;let n=document.createElement("div");n.className="score";let a=document.createElement("h2");a.className="score__title",a.textContent="Puntaje";let s=document.createElement("div");s.className="score__details";let i=document.createElement("p");i.className="score__datail",i.textContent="Vos: 0";let o=document.createElement("p");o.className="score__datail",o.textContent="Máquina: 0",c({id:"result-information",function:e=>{i.textContent="Vos: "+e.statistics.wins,o.textContent="Máquina: "+e.statistics.losses}}),s.appendChild(i),s.appendChild(o),n.appendChild(a),n.appendChild(s),e.appendChild(t),e.appendChild(n)}connectedCallback(){this.render()}}class _ extends HTMLElement{constructor(){super()}render(){let e=this.attachShadow({mode:"open"}),t=document.createElement("style");t.textContent=`
    * {
      margin: 0;
      padding: 0;
    }
    ...
    `;let a=document.createElement("img");a.className="hand",a.src=e(v),a.addEventListener("click",()=>{this.dummy||h(this.type)}),c({id:this.opponent?this.type+"-hand-opponent":this.type+"-hand",function:e=>{let t=e.game.stage;if(this.opponent&&"finishing"==t&&e.hand.opponent==this.type&&(a.className="hand hand__selected-opponent"),!this.dummy){let n=e.hand.player;"selecting"==t?n?n==this.type?a.className="hand hand__active":a.className="hand hand__inactive":a.className="hand":"finishing"==t&&(n==this.type?a.className="hand hand__selected":a.className="hand hand__no-selected")}}}),t.appendChild(n),t.appendChild(a)}connectedCallback(){this.dummy=this.hasAttribute("dummy"),this.opponent=this.hasAttribute("opponent"),this.render()}}var b={};b=new URL("shears.3817db3b.svg",import.meta.url).toString();class y extends HTMLElement{constructor(){super(),this.type="shears"}render(){let t=this.attachShadow({mode:"open"}),n=document.createElement("style");n.textContent=`
    .hand {
      transform: translate(0, 0);
      transition: transform 0.6s ease;
    }
    ...
    `;let a=document.createElement("img");a.className="hand",a.src=e(b),a.addEventListener("click",()=>{this.dummy||h(this.type)}),c({id:this.opponent?this.type+"-hand-opponent":this.type+"-hand",function:e=>{let t=e.game.stage;if(this.opponent&&"finishing"==t&&e.hand.opponent==this.type&&(a.className="hand hand__selected-opponent"),!this.dummy){let n=e.hand.player;"selecting"==t?n?n==this.type?a.className="hand hand__active":a.className="hand hand__inactive":a.className="hand":"finishing"==t&&(n==this.type?a.className="hand hand__selected":a.className="hand hand__no-selected")}}}),t.appendChild(n),t.appendChild(a)}connectedCallback(){this.dummy=this.hasAttribute("dummy"),this.opponent=this.hasAttribute("opponent"),this.render()}}function C({goTo:e}){let t=document.createElement("div");return t.classList.add("container-home"),t.innerHTML=` 
  ...
  `;let a=n.querySelector(".result-modal");return a.addEventListener("bluebuttonpressed",()=>{l({...t,hand:{player:void 0,opponent:void 0},game:{stage:"waiting",result:void 0}}),e("/")}),n.addEventListener("counterended",()=>{var e,n;!function(e){let n=t;l({...n,hand:{player:n.hand.player,opponent:e}})}({0:"rock",1:"paper",2:"shears"}[Math.floor(3*Math.random())]);let s=(e=t.hand.player,n=t.hand.opponent,e&&n?({rockrock:"tie",rockpaper:"lose",rockshears:"win",paperrock:"win",paperpaper:"tie",papershears:"lose",shearsrock:"lose",shearspaper:"win",shearsshears:"tie"})[e+n]:"lose");"win"==s?(function(){let e=t;l({...e,statistics:{wins:e.statistics.wins+1,losses:e.statistics.losses}})}(),p("win")):"lose"==s?(function(){let e=t;l({...e,statistics:{wins:e.statistics.wins,losses:e.statistics.losses+1}})}(),p("lose")):p("tie"),m("finishing"),setTimeout(()=>{a.className="result-modal result-modal__active",m("finished")},1e3)}),m("selecting"),n}}];!function(){!function(){t={statistics:{wins:0,losses:0},hand:{player:void 0,opponent:void 0},game:{stage:"waiting",result:void 0}};let e=localStorage.getItem("statistics");if(e){let n=JSON.parse(e);t.statistics=n}}(),customElements.define("blue-button",o),customElements.define("rock-hand",x),customElements.define("paper-hand",f),customElements.define("shears-hand",y),customElements.define("result-star",_),customElements.define("result-information",g),customElements.define("counter-black",r);let e=document.getElementById("app");e&&function(e){function t(e){history.pushState({},"",e),n(e)}function n(n){let a;for(let e of E)if(e.path.test(n)){a=e.getComponent({goTo:t});break}a||(a=C({goTo:t})),e.firstChild&&e.firstChild.remove(),e.appendChild(a)}n(location.pathname)}(e)}();
//# sourceMappingURL=index.ca40996f.js.map
